...
MAIN:
    BTFSC PORTA,0,A	; Si el bit 0 es = 0, brinca la siguiente instruccion
    GOTO MAL
    BTFSS PORTA,1,A	; Si bit 1 = 1, brinca la siguiente instruccion
    GOTO MAL
    BTFSS PORTA,2,A	; Si bit 2 = 1, brinca la siguiente instruccion
    GOTO MAL
    BTFSS PORTA,3,A	; Si bit 3 = 1, brinca la siguiente instruccion
    GOTO MAL
